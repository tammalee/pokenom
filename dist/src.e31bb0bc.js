...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/pokeapi-js-wrapper/src/endpoints.json":[function(require,module,exports) {
module.exports = [
...
},{}],"../node_modules/pokeapi-js-wrapper/src/rootEndpoints.json":[function(require,module,exports) {
module.exports = [
    ["getEndpointsList", ""],
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/localforage/dist/localforage.js":[function(require,module,exports) {
var define;
...
},{}],"../node_modules/pokeapi-js-wrapper/src/default.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/pokeapi-js-wrapper/src/getter.js":[function(require,module,exports) {
"use strict";
...
function loadResource(url) {
  return new Promise((resolve, reject) => {
    _localforage.default.ready().then(() => {
      _localforage.default.getItem(`${CACHE_PREFIX}${url}`).then(value => {
        if (value === null) {
          loadUrl(url).then(res => {
            resolve(res);
          }).catch(err => {
            reject(err);
          });
...
function loadUrl(url) {
  return new Promise((resolve, reject) => {
    ...
    _axios.default.get(url, options).then(response => {
      ...
      if (response.status >= 400) {
        ...
        if (_default.values.cache) {
          _localforage.default.setItem(`${CACHE_PREFIX}${url}`, response.data);
        }
...
},{"axios":"../node_modules/axios/index.js","localforage":"../node_modules/localforage/dist/localforage.js","./default.js":"../node_modules/pokeapi-js-wrapper/src/default.js"}],"../node_modules/pokeapi-js-wrapper/src/configurator.js":[function(require,module,exports) {
"use strict";
...
},{"localforage":"../node_modules/localforage/dist/localforage.js","./default.js":"../node_modules/pokeapi-js-wrapper/src/default.js"}],"../node_modules/pokeapi-js-wrapper/src/index.js":[function(require,module,exports) {
"use strict";
...
var _endpoints = _interopRequireDefault(require("./endpoints.json"));

var _rootEndpoints = _interopRequireDefault(require("./rootEndpoints.json"));
...
class Pokedex {
  constructor(config) {
    ...
    _configurator.configurator.setRootEndpointConfiguration(config); // add to Pokedex.prototype all our endpoint functions


    _endpoints.default.forEach(endpoint => {
    ...
    _rootEndpoints.default.forEach(rootEndpoint => {
  ...
  resource(path) {
    if (typeof path === 'string') {
      ...
      return Promise.all(path.map(p => (0, _getter.loadResource)(p)));
    } else {
...
},{"./endpoints.json":"../node_modules/pokeapi-js-wrapper/src/endpoints.json","./rootEndpoints.json":"../node_modules/pokeapi-js-wrapper/src/rootEndpoints.json","./getter.js":"../node_modules/pokeapi-js-wrapper/src/getter.js","./default.js":"../node_modules/pokeapi-js-wrapper/src/default.js","./configurator.js":"../node_modules/pokeapi-js-wrapper/src/configurator.js"}],"lib/config.js":[function(require,module,exports) {
"use strict";
...
},{"pokeapi-js-wrapper":"../node_modules/pokeapi-js-wrapper/src/index.js"}],"lib/Helpers.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Helpers, null, [{
    ...
    value: function clearContent() {
      _config.default.body.className = '';
      _config.default.articleContainer.innerHTML = '';
    }
  }, {
...
},{"./config":"lib/config.js"}],"lib/Berries.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Berries() {
    _classCallCheck(this, Berries);
  }

  _createClass(Berries, null, [{
    key: "setBerryNames",
    ...
    key: "getBerryNames",
    value: function getBerryNames() {
      var berryNames = [];

      if (localStorage.getItem(_config.default.lsBerryNames)) {
        berryNames = JSON.parse(localStorage.getItem(_config.default.lsBerryNames));
      } else {
        this.setBerryNames();
        berryNames = JSON.parse(localStorage.getItem(_config.default.lsBerryNames));
      }
